...
deep_config1 = dict(weight_decay=0.01, steps=steps, epoch_div=3, epoch_div_factor = 1000,
        lrs = (4,4), momentum=(0.9,0.9), clip_val= 3e-1, optim_type='SGD',
        num_layer=1, wide=True, Optimize_C=True)
deep_config2 = deepcopy(deep_config1)
deep_config2['num_layer'] = 2
algos_dict = {
    'mom': [meta.apply_method_of_moments,{}, n_repeat, 'MoM', '--sg'],
    'altmingd_wd_lyr1': [meta.apply_alt_min_gd_wd, deep_config1, n_repeat, 'AltMinGD-DWD-1L', '--sy'],
    'altmingd_wd_lyr2': [meta.apply_alt_min_gd_wd, deep_config2, n_repeat, 'AltMinGD-DWD-2L', '--sk'],
...
m = [12, 20] # number of observations per task
rho = 2 # ratio
