...
deep_config = dict(weight_decay=0.01, steps=steps, epoch_div=3, epoch_div_factor = 1000,
        lrs = (4,4), momentum=(0.9,0.9), clip_val= 3e-1, optim_type='SGD',
        num_layer=2, wide=True, Optimize_C=True)

algos_dict = {
    'mom': [meta.apply_method_of_moments,{}, n_repeat, 'MoM', '--sg'],
    'altmingd_wd_lyr1': [meta.apply_alt_min_gd_wd, deep_config, n_repeat, 'AltMinGD-DWD-1L', '--sy'],
    'altmingd_wd_lyr2': [meta.apply_alt_min_gd_wd, deep_config, n_repeat, 'AltMinGD-DWD-2L', '--sk'],
...
m = [8, 12] # number of observations per task
rho = 4 # ratio
